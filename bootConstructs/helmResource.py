...
class HelmChartConstruct(Construct):
    ...
    def __init__(self, scope: Construct, id: str, ekscluster: eks.Cluster, helm_values: dict, conf, **kwargs) -> None:
    ...
    def _deploy_nginx_helm_chart(self, cluster: eks.Cluster, values: dict) -> eks.HelmChart:
        try:
            nginxChart = eks.HelmChart(self, "nginxChart",
                cluster=cluster,
                chart="ingress-nginx",
